...
/**
 * HTTP client wrapper for the Anthropic Claude REST API.
 * Sends JSON requests and extracts plain-text responses.
 */
@Component
public class ClaudeApiClient {
     ...
     * @return extracted text content from Claude response
     */
